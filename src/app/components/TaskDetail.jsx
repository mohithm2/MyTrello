...
const TaskDetail = ({
    ...
    return (
        <div className="card p-3 col-6">
            ...
            <div>
                    <input type="date" value={task.date} onChange={setTaskDate} className="form-control form-control-lg"/>
            </div>
            
            <div>
                    <input type="file" value={task.file} onChange={setTaskFile} className="form-control form-control-lg"/>
            </div>
...
function mapDispatchToProps(dispatch, ownProps){
    ...
    return {
        ...
        setTaskDate(e){
            dispatch(setTaskDate(id,e.target.value));
        },
        setTasfFile(e){
            dispatch(setTaskFile(id,e.target.value));
        },
